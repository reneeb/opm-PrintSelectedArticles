...
# Changes Copyright (C) 2014 - 2016 Perl-Services.de, http://perl-services.de
# --
...
#    my $ArticleID = $ParamObject->GetParam( Param => 'ArticleID' );
    my @ArticleID = $ParamObject->GetArray( Param => 'ArticleID' );
# ---
...
#            Text     => $LayoutObject->{LanguageObject}->Translate('Article') . ' #' . $ArticleNumber,
            Text     => $LayoutObject->{LanguageObject}->Translate('Article') . ' #' . ( $Article{__PS_ARTICLECOUNTER__} // $ArticleNumber ),
# ---
            Height   => 10,
            Type     => 'Cut',
            Font     => 'Proportional',
